...
Obtaining FLocalX version
============================

To find out your FLocalX version number, import it and print the
...
.. _locating-flocalx-install:

:file:`flocalx` install location
===================================

You can find what directory FLocalX is installed in by importing it
and printing the ``__file__`` attribute::

    >>> import flocalx
    >>> flocalx.__file__
    '/Users/guillermo/Documents/flocalx/__init__.py'
...
There are a number of good resources for getting help with FLocalX.
There is a good chance your question has already been asked:

- `GitHub issues <https://github.com/Kaysera/flocalx/issues>`_.
...
* FLocalX version::
     ...
     python -c "import flocalx; print(flocalx.__version__)"

* Where you obtained FLocalX (e.g., GitHub or PyPI).
